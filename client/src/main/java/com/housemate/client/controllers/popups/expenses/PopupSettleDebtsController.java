...
public class PopupSettleDebtsController {
    ...
    public PopupSettleDebtsController(AppServices services, MainController mainController, TabExpensesController parentTab) {
    ...
    public void handlePopupClosing() {
        mainController.closePopup(popupOverlay);
    }
