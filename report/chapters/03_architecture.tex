...
\begin{tikzpicture}[
    ...
    \node[box, minimum height=1cm, fill=yellow!10] (shared) at (0, -1.75) {\textbf{Shared Module} \\ (DTOs \& Models)};
...
\section{Detailed General Architecture Diagram}
...
\begin{figure}[H]
    ...
    \begin{tikzpicture}[
        ...
        \node[umlbox] (model)       at (7.75, -11.75) {Models};
    ...
    \end{tikzpicture}
    \caption{Detailed general architecture diagram}
